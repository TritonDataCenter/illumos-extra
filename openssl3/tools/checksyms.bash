...
ALLOWED_SYMS="$ALLOWED_SYMS OPENSSL_SMARTOS_3.0.8 OPENSSL_SMARTOS_3.0.9"
ALLOWED_SYMS="$ALLOWED_SYMS OPENSSL_SMARTOS_3.1.0 OPENSSL_SMARTOS_3.2.0"
ALLOWED_SYMS="$ALLOWED_SYMS OPENSSL_SMARTOS_3.3.0 OPENSSL_SMARTOS_3.4.0"
ALLOWED_SYMS="$ALLOWED_SYMS OPENSSL_SMARTOS_3.5.0"
